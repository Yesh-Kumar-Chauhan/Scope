...
const Scope21TimesheetExcel = async (reportData: any) => {
    ...
    reportData.forEach((employee: any, index: number) => {
        ...
        worksheet.getCell(`A${currentRow}`).value = 'SCOPE 2:1 - Time Sheet';
        ...
        const timeSheetData = [
            ...
            ["Max Hours:", ` ${employee?.Max_Hours} a week`, "", "", "", "", "", "", "Program:", employee?.SITE_NAM],
...
export default Scope21TimesheetExcel;
