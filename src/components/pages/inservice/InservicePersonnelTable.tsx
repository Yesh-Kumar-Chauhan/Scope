...
interface InserviceTableProps {
    ...
    onEditInservice: (inservice: IInservice) => void;
    handleCreateNewInservice: any;
}

const InservicePersonnelTable: React.FC<InserviceTableProps> = ({ setShowInserviceBasicTable, onEditInservice, handleCreateNewInservice }) => {
    ...
    const columns: ColumnDef<IInserviceTable>[] = [
        ...
        },
        {
            ...
            header: 'ACTION',
            cell: ({ row }) => (
                <button className='btn btn-primary px-3 py-0 h-auto' style={{ minHeight: 'auto', minWidth: 'auto' }}
...
export default InservicePersonnelTable