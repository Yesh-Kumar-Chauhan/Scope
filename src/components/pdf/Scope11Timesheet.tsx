...
interface Scope11TimesheetProps {
    data: any;
}

const Scope11Timesheet: React.FC<Scope11TimesheetProps> = ({ data }) => {
            ...
            <Page size="A4" style={styles.page} orientation="landscape">
                <View>
                    <div style={styles.section}>
                        <Text style={styles.header}>SCOPE 1:1 - Time Sheet</Text>
                    </div>
                    {data.length > 0 ? (
...
export default Scope11Timesheet